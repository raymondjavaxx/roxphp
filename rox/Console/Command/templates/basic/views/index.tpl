!<h1><?php echo htmlspecialchars(Rox_Inflector::pluralize($model->getModelVarName())) ?></h1>
...
echo "<p><?php echo \$html->link('New {$model->getFriendlyModelName()}', '/{$controller->getName()}/new') ?></p>\n\n";

echo "<?php echo \$pagination->links(\${$model->getPluralModelVarName()}) ?>\n";
?>